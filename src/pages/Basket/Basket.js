...
function Basket() {
    ...
    const addedCpu = Object.keys(items).map((key) => {
            ...
            <div className="content">
                <div className="container container--basket">
                    <div className="basket">
                        <div className="baskett__top d-flex">
                            ...
                            Корзина</h2>
                            <div className="basket__clear ml-auto" onClick={onClearBasket}>
                        ...
                        <div className="basket__bottom">
                            <div className="basket__bottom-details">
                                <span> Всего процессоров: <b>{totalCount} шт.</b> </span>
